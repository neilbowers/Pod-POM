...
#
# REVISION
#   $Id: Head5.pm 89 2013-05-30 07:41:52Z ford $
#
#========================================================================

package Pod::POM::Node::Head5;
...
our @ACCEPT  = qw( head6 over begin for text verbatim code );
...
This module implements a specialization of the node class to represent C<=head5> elements.
